...
%% Functional portion- First we want to combine look at the variation between the whole brain for different scans
...
for i=1:1:a
    ...
    for k=1:1:c
        ...
        ModeStds(i,k)=std(ModeVals(i,:,k));
        
        if i==3 && ModeStds(i,k)<0.015097
            k
        end
