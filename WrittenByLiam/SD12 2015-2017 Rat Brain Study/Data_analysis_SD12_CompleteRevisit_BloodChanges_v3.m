...
% [BloodFromPeak, BloodFromPeakStd, ROIave, ROIStds, BloodTQAve, BloodTQStd, BloodMax] =get_BloodValues(3);
    ...
    for x=1:1:200
        for y=1:1:200
            for z=1:1:200
                ...
                I_Timg(x,y,z)=(PostConImg(x,y,z)-CBVImg(x,y,z)*BloodFromPeak(i,totscan))/denom;
            end
        end
    end
...
if capmaskcrop==1
    filename=strcat('Statistics_SD12_CBV_',r_num,'_redoFromCBVniis_Blood3_capmaskcrop.csv');
else
    filename=strcat('Statistics_SD12_CBV_',r_num,'_redoFromCBVniis_Blood3.csv');
end
