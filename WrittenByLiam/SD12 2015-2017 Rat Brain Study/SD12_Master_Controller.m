...
binsize=0.01; %initially we used .001 for calculating the data and .01 for displaying the histograms
...
for i=1:1:a
    ...
    for j=1:1:4
        ...
        saveName=strcat(folder1,'/map_Rat_', valueType, '_', state, '_', s, '_Atlas.nii');
        ...
        for k=1:1:2
            ...
            [FigureMatrixAxial] =get_AtlasFigure_v2(CurrentImg, Axial_slices, 'axial', layout);
            [FigureMatrixCoronal] =get_AtlasFigure_v2(CurrentImg, Coronal_slices, 'coronal', layout);
...
for i=1:1:2
    ...
    for j=1:1:3
        ...
        CurrentNii=get_ValsMappedToAtlas_V2(CurrentVals);
        saveName=strcat(folder1,'/map_Rat_', valueType, '_', state, '_', s, '_Atlas_OnlyStatSig.nii');
        save_nii(CurrentNii,saveName);
