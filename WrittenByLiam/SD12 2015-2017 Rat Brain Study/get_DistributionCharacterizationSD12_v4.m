function [MeanVals, MedianVals, ModeVals, MMDiffVals, RMSVals, RSqrTotGaussVals, RSqrOfModeGaussian, FitInfo, ProblemRegions, WindowHistFit, FullHistFit, ResidualOfFit] =get_DistributionCharacterizationSD12_v4(myDataRaw,myDataHist)

% Adapted from get_DistributionCharacterizationSD12_v2 to cut out unused
% measures and add possible new ones
