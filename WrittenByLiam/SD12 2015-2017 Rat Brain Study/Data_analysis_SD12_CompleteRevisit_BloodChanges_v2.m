...
if capmaskcrop==1
filename=strcat('Statistics_SD12_CBV_',r_num,'_redoFromCBVniis_Blood2_capmaskcrop.csv');
else
    filename=strcat('Statistics_SD12_CBV_',r_num,'_redoFromCBVniis_Blood2.csv');
end
